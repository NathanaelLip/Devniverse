                                    ...
                                    <template #trigger>
                                        <span class="inline-flex rounded-md">
                                            <button type="button"
                                                ...
                                                <svg v-if="$page.props.auth.user.isVerified" class="ml-2 -mr-0.5 h-4 w-4 text-purple-600 dark:text-purple-400 rounded-md" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
                                                    <path
