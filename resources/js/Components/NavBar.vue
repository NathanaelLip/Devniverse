...
<!-- This is how to need to put this on each file.
        ...
        <nav class="w-full bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="shrink-0 flex items-center">
                            <Link href="/">
                            <ApplicationLogo
                                class="align-self-center block h-9 w-auto fill-current text-gray-800 dark:text-gray-200" />
                            </Link>
                        </div>
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-6">
                        ...
                        <div class="ml-3 relative">
                            <div v-if="canLogin" class="flex mr-4" style="align-items: center;">
                                <Link v-if="$page.props.auth.user" href="" class="hidden"></Link>
                                <template v-else>
                                    <Link :href="route('login')"
                                        class="ml-4 inline-flex items-center px-1 pt-1 text-sm font-medium leading-5 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none focus:text-gray-700 dark:focus:text-gray-300 focus:border-gray-300 dark:focus:border-gray-700 transition duration-150 ease-in-out">
                                    Log in</Link>
                                ...
                                <template #trigger>
                                    <span class="inline-flex rounded-md">
                                        <button type="button"
                                            ...
                                            <svg v-if="$page.props.auth.user.isVerified"
                                                class="ml-2 -mr-0.5 h-4 w-4 text-purple-600 dark:text-purple-400 rounded-md"
            ...
            <div :class="{ block: showingNavigationDropdown, hidden: !showingNavigationDropdown }" class="sm:hidden">
                <div class="pt-2 pb-3 space-y-1">
					...
					<ResponsiveNavLink :href="route('marketplace')" :active="route().current('Marketplace')">
                        Marketplace
                    </ResponsiveNavLink>
