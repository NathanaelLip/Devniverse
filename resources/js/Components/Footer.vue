		...
		<div class="container mx-auto px-4">
					...
					<div class="flex flex-wrap">
						<div class="w-full ml-auto">
							<ul class="list-unstyled">
								...
								<li>
									<a class="text-gray-600 dark:text-gray-400 hover:underline py-1 text-lg"
										href='/site-rules'>Site
										Rules</a>
								</li>
			...
			<div class="flex flex-wrap items-center md:justify-between justify-center">
				<div class="w-full md:w-6/12 px-4 mx-auto text-center">
					<div class="w-full flex justify-center pb-4 gap-4 text-gray-600 dark:text-gray-400">
						<a href="https://discord.gg/Bdx9z9XFAj">
							<svg class="text-lg w-8 h-8 hover:text-blue-600 dark:hover:text-blue-700 transition-all"
						...
						<a href="https://twitter.com/Devniverse">
							<svg class="text-lg w-8 h-8 hover:text-blue-400 transition-all" fill="currentColor"
